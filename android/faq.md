...
本アプリの打牌推薦モデルは、**多数の評価軸を内部で同時に学習** しています。画面に表示している打牌指標 (= 放銃確率・失点・和了確率・期待打点) は、AI が考慮している要素の **一部** にすぎません。

AI は表示指標以外にも、以下のような要素を内部で考慮しています:

- 手牌進行の柔軟性 (= 将来の選択肢の広さ)
- テンパイまでの速度・テンパイ時の待ち牌の質
- 役の作りやすさ
- 場況や段階による戦略の調整
...
- 発生時刻
- 匿名化された無作為のインストール識別子 (= 利用者個人を特定しません)

撮影画像・履歴・成績などのコンテンツデータは送信されません。収集されたクラッシュ情報は、本アプリの不具合修正と品質改善のみに利用します。

詳細は [プライバシーポリシー §5](/JongPilot/android/privacy/) をご参照ください。

### Q17. アンインストールするとデータはどうなりますか?
